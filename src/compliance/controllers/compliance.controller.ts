import {
  ...
  export class ComplianceController {
    ...
    async createRegulation(
      ...
      return this.complianceService.createRegulation(createRegulationDto, req.user.id);
    }
    ...
    async createRequirement(
      ...
      return this.complianceService.createComplianceRequirement(createRequirementDto, req.user.id);
    }
    ...
    async createAssessment(
      ...
      this.logger.log(`Creating assessment for requirement: ${createAssessmentDto.requirementId}`);
      return this.complianceService.createComplianceAssessment(createAssessmentDto);
    }
    ...
    async logPhiAccess(
      @Body() auditLogDto: CreateAuditLogDto,
    ) {
    ...
    async getPhiAccessReport(
      ...
      return this.hipaaService.getPhiAccessReport(new Date(startDate), new Date(endDate));
    }
  }
