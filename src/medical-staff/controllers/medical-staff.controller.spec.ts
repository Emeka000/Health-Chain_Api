...
describe("MedicalStaffController", () => {
      ...
      providers: [
        ...
        },
        {
          ...
          useValue: {
            ...
            checkAvailability: jest.fn().mockResolvedValue({ available: true, conflicts: [], suggestions: [] }),
            getSchedulingConflicts: jest.fn().mockResolvedValue({ conflicts: [], summary: {} }),
          },
        },
        {
  ...
  describe("createDoctor", () => {
    it("should create a doctor", async () => {
      ...
      expect(medicalStaffService.createDoctor).toHaveBeenCalledWith(createDoctorDto)
    })
  })
  ...
  describe("createSchedule", () => {
    it("should create a schedule", async () => {
      ...
      expect(schedulingService.createSchedule).toHaveBeenCalledWith(createScheduleDto)
    })
  })

  describe("checkAvailability", () => {
    it("should check doctor availability", async () => {
      const result = await controller.checkAvailability("1", new Date(), "09:00", "10:00")
