import {
  ...
  import { MedicalRecordVersion, VersionChangeType } from '../../entities/medical-record-version.entity';
  import { MedicalTimeline, TimelineEventType } from '../../entities/medical-timeline.entity';
  ...
  export class MedicalRecordsService {
    ...
    async update(
      ...
      const updatedRecord = await this.medicalRecordRepository.save(existingRecord);
