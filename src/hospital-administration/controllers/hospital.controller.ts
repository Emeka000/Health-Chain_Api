...
export class HospitalController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Hospital created successfully' })
  async create(@Body() createHospitalDto: CreateHospitalDto): Promise<CustomApiResponse<any>> {
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Hospital retrieved successfully' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Hospital updated successfully' })
  async update(
    @Param('id') id: string,
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Hospital deleted successfully' })
