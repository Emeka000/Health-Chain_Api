...
export class StaffController {
  ...
  async createSchedule(@Param('id') id: string, @Body() scheduleDto: any): Promise<CustomApiResponse<any>> {
  ...
  async getSchedule(@Param('id') id: string, @Query() query: any): Promise<CustomApiResponse<any>> {
