...
export class PrescriptionController {
  ...
  async verify(
    ...
    return await this.prescriptionService.verifyPrescription(
      id,
      body.pharmacistId,
    );
  }
  ...
  async fill(
    ...
    return await this.prescriptionService.fillPrescription(
      id,
      body.pharmacistId,
    );
  }
  ...
  async dispense(
    ...
    return await this.prescriptionService.dispensePrescription(
      id,
      body.pharmacistId,
    );
  }
