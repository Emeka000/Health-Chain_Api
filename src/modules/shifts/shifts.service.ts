...
export class ShiftsService {
  ...
  async createHandoff(createHandoffDto: CreateShiftHandoffDto): Promise<ShiftHandoff> {
  ...
  async completeHandoff(handoffId: string, comments?: string): Promise<ShiftHandoff> {
