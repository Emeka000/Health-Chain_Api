...
export class ConfigurationController {
  ...
  async createConfiguration(
    @Body() createConfigDto: any,
  ): Promise<CustomApiResponse<any>> {
    const config =
      await this.configurationService.createConfiguration(createConfigDto);
    return {
      success: true,
      data: config,
  ...
  async updateConfiguration(
    ...
    const config = await this.configurationService.updateConfiguration(
      key,
      updateDto,
    );
    return {
  ...
  async resetToDefaults(
    @Body() resetDto: { keys?: string[] },
  ): Promise<CustomApiResponse<any>> {
    const result = await this.configurationService.resetToDefaults(
      resetDto.keys,
    );
    return {
      success: true,
  ...
  async bulkUpdateConfigurations(
    ...
    const result =
      await this.configurationService.bulkUpdateConfigurations(bulkUpdateDto);
    return {
      success: true,
      data: result,
  ...
  async getConfigurationHistory(
    ...
    const history =
      await this.configurationService.getConfigurationHistory(query);
    return {
      success: true,
      data: history,
    };
  ...
  async validateConfigurations(
    @Body() configsToValidate: any[],
  ): Promise<CustomApiResponse<any>> {
    const validation =
      await this.configurationService.validateConfigurations(configsToValidate);
    return {
      success: true,
      data: validation,
    };
  ...
  async restoreFromBackup(
    @Body() restoreDto: { backupId: string },
  ): Promise<CustomApiResponse<any>> {
    const result = await this.configurationService.restoreFromBackup(
      restoreDto.backupId,
    );
    return {
      success: true,
  ...
  async updateHospitalSettings(
    ...
    const settings =
      await this.configurationService.updateHospitalSettings(settingsDto);
    return {
      success: true,
      data: settings,
  ...
  async updateBillingSettings(
    ...
    const settings =
      await this.configurationService.updateBillingSettings(settingsDto);
    return {
      success: true,
      data: settings,
  ...
  async updateNotificationSettings(
    ...
    const settings =
      await this.configurationService.updateNotificationSettings(settingsDto);
    return {
      success: true,
      data: settings,
  ...
  async updateSecuritySettings(
    ...
    const settings =
      await this.configurationService.updateSecuritySettings(settingsDto);
    return {
      success: true,
      data: settings,
  ...
  async testConnections(
    @Body() testDto: { systems: string[] },
  ): Promise<CustomApiResponse<any>> {
    const results = await this.configurationService.testConnections(
      testDto.systems,
    );
    return {
      success: true,
