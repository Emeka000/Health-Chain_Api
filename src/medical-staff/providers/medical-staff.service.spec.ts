...
describe("MedicalStaffService", () => {
  ...
  beforeEach(async () => {
    ...
    licenseRepository = module.get<Repository<MedicalLicense>>(getRepositoryToken(MedicalLicense))
    ...
    educationRepository = module.get<Repository<ContinuingEducation>>(getRepositoryToken(ContinuingEducation))
  })
  ...
  describe("createDoctor", () => {
    ...
    it("should throw ConflictException if license number already exists", async () => {
      ...
      await expect(service.createDoctor(createDoctorDto)).rejects.toThrow(ConflictException)
    })
  })
  ...
  describe("renewLicense", () => {
    ...
    it("should throw NotFoundException if license not found", async () => {
      ...
      await expect(service.renewLicense("999", new Date())).rejects.toThrow(NotFoundException)
    })
  })
})
