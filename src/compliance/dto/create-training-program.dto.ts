...
export class CreateTrainingProgramDto {
  ...
  @ApiProperty({
    example:
      'Comprehensive HIPAA training covering privacy and security requirements',
  })
  @IsString()
  @MinLength(10)
  description: string;
  ...
  @ApiPropertyOptional({
    example: 12,
    description: 'Recertification period in months',
  })
  @IsOptional()
  @IsNumber()
  @Min(1)
